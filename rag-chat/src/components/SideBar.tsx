...
import {
  MessageSquare, Book, Map, LifeBuoy, HelpCircle, ClipboardList,
} from 'lucide-react';
  ...
  return (
    <>
      ...
      {(variant === 'desktop' || variant === 'both') && (
        <aside
          className={`hidden sm:flex flex-col h-[calc(100vh-60px)] overflow-y-auto transition-all duration-300 ${bgColor} w-full p-3`}
        >
          {!collapsed && (
